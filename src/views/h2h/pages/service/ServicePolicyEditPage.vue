              ...
              <b-row>
                <b-col>
                  ...
                  <div class="d-flex justify-content-end">
                    ...
                    <b-button
                      variant="danger"
                      :to="'/service/servicepolicy/' + serviceid"
                      class="ml-2"
                      >Back</b-button
                    >
                  </div>
...
export default {
  ...
  methods: {
    ...
    updatePolicy() {
      ...
      let selectedUsers = [];
      for (let l = 0; l < this.selectedUsers.length; l++) {
        selectedUsers.push(this.selectedUsers[l].userId);
      }
  ...
  created() {
    ...
    this.$http
      .get("/api/userservice/" + this.serviceid)
      .then((response) => {
