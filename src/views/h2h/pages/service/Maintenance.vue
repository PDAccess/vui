                ...
                <b-col md="6">
                  <b-form-group for="selectedUsers" horizontal>
                    <label class="typo__label"
                      >Allowed Users in Maintenance</label
                    >
                    <p-select
                      v-model="value"
            ...
            >
              ...
              <b-row>
                <b-col class="d-flex justify-content-end">
                  <b-button
                    variant="success"
                    @click.stop="editMaintenance"
                    class="mr-2"
                    >Edit</b-button
                  >
                  <b-button variant="info" @click.stop="clearForm"
                    >Clear Form</b-button
                  >
                </b-col>
              </b-row>
            ...
            >
              ...
              <template v-slot:cell(action)="row">
                ...
                >
                  ...
                  <b-dropdown-item
                    @click.stop="
                      firstEditButton(row.item, row.index, $event.target)
                    "
