          ...
          <download-excel
            ...
            >
              <b-button
                ...
                ref="excelBtn"
              >
                <em class="fa fa-download mr-2"></em>Download Service List
              </b-button>
            </download-excel>
          <li
  ...
  data() {
    return {
      excelField: {
        ...
        "Operating System": "serviceNameLogo",
        "Type": "serviceTypeLogo",
    ...
    async exportExcel() {
      ...
      services.forEach((f) => {
        excelData.push({
          ...
          serviceNameLogo: f.serviceNameLogo,
          serviceTypeLogo: f.serviceTypeLogo,
          ipAddress: f.ipAddress,
          port: f.port,
          createdAt: this.$moment(f.createdAt).format("hh:mm:s Y/MM/DD"),
          lastAccessTime: this.$moment(f.lastAccessTime).format("hh:mm:ss Y/MM/DD"),
        });
      });
