        ...
        <ul class="list-group list-group-flush">
          <li class="list-group-item">
            ...
            <b-row class="my-1">
              ...
              <b-col sm="8">
                <b-form-group
                  description="Add description for Alarm"
                  horizontal
                >
...
export default {
  ...
  methods: {
    ...
    createAlarm() {
      let users = [];
      for (let value of this.formdata.users) {
      ...
      this.$http
        .post("/api/v1/alarm/services/" + this.id, data)
        .then((response) => {
          this.$bvToast.toast(`Created Alarm`, {
    ...
    this.$http
      ...
      .then((response) => {
        response.data.userPolicyWrappers.forEach((element) => {
          this.userOptions.push(element.user);
        });
        this.loading = false;
      })
      .catch((error) => {
