    ...
    <div class="animated fadeIn">
      ...
      <div v-else>
        <div v-if="items.length === 0">
          <p-initial icon="file-plus" header="Not found any Public Playbook" message="Please wait for other users to create public Playbook." />
        </div>
...
export default {
  ...
  methods: {
    ...
    getPlaybook() {
      this.loading = true;
      this.$http
        .get("/api/v1/playbook/public/" + this.user.userId)
        .then((response2) => {
